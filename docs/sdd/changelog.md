...
### 变更类型：新增
- 影响 REQ：REQ-010
- 变更描述：T-008 苏格拉底式任务跟进：JsonSchema/启发式抽取、完成/暂缓、截止 24h/`importantTopics`→HIGH、`TaskFollowUpGate`+日配额、提问式 nudge；T-007 用户验收通过
- 新增任务：无（T-008 👀）
- 原因：设计方案 §4 功能点4；承接 REQ-006 HIGH 判定分期
